...
Errors motor_enable(uint16_t id) {
    ...
    return m281_enable(motors.motor[id].port, motors.motor[id].pin_number);
}
...
Errors motor_disable(uint16_t id) {
    ...
    return m281_disable(motors.motor[id].port, motors.motor[id].pin_number);
}
